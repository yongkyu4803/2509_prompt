...
| 모델명 | 최대 컨텍스트 윈도우 | 파일 업로드 및 분석 | 주요 요약 스타일 | 특장점 및 실무 팁 | 접근성 및 비용 |
|--------|---------------------|-------------------|-----------------|-------------------|----------------|
| **ChatGPT (GPT-5)** | 128k 토큰 | PDF, 워드, 한글 등 지원 | 설명형, 서술적 요약 | 복잡한 논리와 근거 설명에 강함. 인터랙티브 대화형 질의응답 최적화 | 유료 구독 권장, 무료는 GPT-3.5 기반 제한적 사용 가능 |
| **Claude 4** | 200k+ 토큰 | PDF, 워드, 한글 PDF 및 표/그래프 자동 추출 강화 | 간결한 Bullet point 요약 | 대용량 문서 처리 및 표/그래프 자동 추출 기능 우수. 보안 강화 옵션 제공 | 무료 체험 가능, 전문 사용 시 유료 플랜 필요 |
| **Gemini 2.5 Pro** | 수백~수천 페이지 분량 | 멀티모달(텍스트+이미지+표+그래프+코드) 분석 지원, 구글 생태계 연동 강화 | 멀티모달 통합 요약 및 도식화 | 복합 문서 및 시각자료, 코드 분석에 탁월. 구글 서비스와의 연동성 우수 | 구글 생태계 연동, 유료 서비스 중심 |
